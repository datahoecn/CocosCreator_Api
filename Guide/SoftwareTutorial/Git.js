...
git checkout fileName		撤销修改，只适合没执行 add
git reset 	执行过add，撤回，再 git checkout fileName
...
inurl
	...
	inurl:搜索引擎优化 返回的结果都是网址url 中包含“搜索引擎优化”的页面
inanchor (百度不支持)
...
配置
	...
	git config [--global] user.emall "[emall address]"
