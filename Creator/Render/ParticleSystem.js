...
this.particle_node.getComponent(cc.ParticleSystem).stopSystem()
this.particle_node.getComponent(cc.ParticleSystem).resetSystem()
...
粒子系统的组成
	...
	粒子发射器
		粒子发射器主要用来产生、回收粒子。创建粒子系统时，首先把粒子发射器放在某个位置，
